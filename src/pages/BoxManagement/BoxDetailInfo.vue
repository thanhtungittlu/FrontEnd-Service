            ...
            <div class="col-md-8">
                <card>
                    <template slot="header">
                        <h3 class="card-title"><b>Box information</b></h3>
                    </template>
                        ...
                        <b-table 
                            ...
                            <template v-slot:cell(last_collumn)="data">
                                ...
                                <div v-else-if="data.index==7">
                                    <ul id="example-1">
                                        <li v-for="camera in data.value" :key="camera.link">
                                            <div
                                                v-if="camera.status=='Online'"
                                                @click="getInfoCamera(camera)"
                                            >
                                                <span class="green-info-dot"></span>
                                                {{ camera.link }}
                                            </div>
                                            <div
                                                v-else-if="camera.status=='Offline'"
                                                @click="getInfoCamera(camera)"
                                            >
                                            <span class="grey-info-dot"></span>
                                                {{ camera.link }}
                    ...
                    <div class="disable-actions">
                        ...
                        class="btn-action"
                            @click="deleteTable()"
                        >
                            <p style="color:white; padding-top:10%"><b>Disable Box</b></p>
                        </div>
                    </div>
                </card>
            </div>
...
export default {
    ...
    data() {
        return {
            items: [
                { first_collumn: "BOX NAME", last_collumn: "Hàng Ngang 3" },
                { first_collumn: "BOX STATUS", last_collumn: "Online" },
                { first_collumn: "BOX ID", last_collumn: "214125432465ad" },
                { first_collumn: "REGISTER DATE", last_collumn: "10/12/2020" },
                { first_collumn: "VPN ADDRESS", last_collumn: "10.2.2.112" },
                { first_collumn: "FUNCTION", last_collumn: "People counting" },
                { first_collumn: "NOTE", last_collumn: "ổn" },
                { first_collumn: "CAMERA", last_collumn: [
                    {
                        "status": "Online",
                        "link": "alo1"
                    }, 
